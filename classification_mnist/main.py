...
def get_parser():
    ...
    parser.add_argument('--total_epoch', default=10, type=int, help='Total number of training epochs')
    parser.add_argument('--decay_epoch', default=7, type=int, help='Number of epochs to decay learning rate')
